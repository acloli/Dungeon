...
namespace Dungeon.Runtime.InGame.Battle
{
    ...
    public class BattleSceneLifetimeScope : LifetimeScope
    {
        ...
        protected override void Configure(IContainerBuilder builder)
        {
            ...
            builder.Register<Services.BattleMapGenerator>(Lifetime.Singleton).As<Services.IBattleMapGenerator>();
            ...
            builder.Register<Services.BattleCardUpgradeService>(Lifetime.Singleton).As<Services.IBattleCardUpgradeService>();
